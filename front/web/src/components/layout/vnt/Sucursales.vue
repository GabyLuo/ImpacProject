          ...
          <div class="col-sm-12">
            <div class="q-pa-sm q-gutter-sm">
              <q-breadcrumbs align="left">
                ...
                <q-breadcrumbs-el label="Empresas" to="" @click.native="close()"/>
                <q-breadcrumbs-el :label="'Sucursales - ' + empresa"/>
              </q-breadcrumbs>
            </div>
          </div>
        </div>
            ...
            <div class="row q-col-gutter-xs">
              <div class="col-sm-6 pull-left">
                <div class="col-xs-12 col-sm-12 col-md-12 pull-left" >
                  <q-btn @click="close()" class="btn_regresar" icon="fa-arrow-left" style="margin-right: 10px;"/>
                </div>
              </div>
    ...
    <div v-if="views.create_direccion">
      ...
      <div class="q-pa-md bg-grey-3">
        <div class="row bg-white border-panel">
          ...
          <div class="col q-pa-md col-sm-12">
            {{ form_sucursales.fields.empresa }}
          </div>
          <div class="col q-pa-md col-sm-12">
            <div class="row q-col-gutter-xs">
              <div class="col-sm-6">
                <q-field icon="location_city" icon-color="dark">
              ...
              <div class="col-sm-3">
                <q-field icon="fas fa-home" icon-color="dark" :error="$v.form_sucursales.fields.tipo.$error" error-label="Elija el tipo">
              ...
              <div class="col-sm-3">
                <q-field icon="fas fa-home" icon-color="dark" :error="$v.form_sucursales.fields.tipo_oficina.$error" error-label="Elija el tipo de oficina">
              ...
              <div class="col-sm-3">
                <q-field icon="fas fa-home" icon-color="dark" :error="$v.form_sucursales.fields.tipo_propiedad.$error" error-label="Elija el tipo de propiedad">
...
export default {
  ...
  methods: {
    ...mapActions({
      getSucursalesByEmpresa: 'vnt/sucursales/getByEmpresa',
      saveSucursal: 'vnt/sucursales/save',
      updateSucursal: 'vnt/sucursales/update',
      deleteSucursal: 'vnt/sucursales/delete',
    ...
    async cargarDirecciones () {
      ...
      this.getSucursalesByEmpresa({empresa_id: this.empresa_id}).then(({data}) => {
    ...
    close () {
      this.$emit('closeSucursales', false)
    }
  },
  validations: {
    form_sucursales: {
