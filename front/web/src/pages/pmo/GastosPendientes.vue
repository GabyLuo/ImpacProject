      ...
      <div class="row" v-if="views.grid">
        <div class="col-sm-12">
          <div class="row justify-between">
            <div class="col-sm-6">
              <q-btn size="15px" icon="attach_money" disable class="btn_categoria" label="PAGOS" />
            </div>
          </div>
            ...
            <div class="col-sm-9">
              <div class="row justify-end">
                <!-- <div class="col-sm-2" style="text-align: right;"> -->
                  <q-btn v-if="this.form_solicitudes.fields.autorizacion_id===0" style="margin-right: 10px" @click="form_solicitudes.solicitudes_proyecto = true" class="btn_rechazar" icon="clear">Rechazar</q-btn>

                  <q-btn v-if="this.form_solicitudes.fields.autorizacion_id===0" style="margin-right: 10px" @click="pagar()" class="btn_regresar" icon="done_all">Pagar</q-btn>
                <!-- </div> -->
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      solicitudeslibres: 'fin/pagos/solicitudeslibres',
  ...
  methods: {
    ...mapActions({
      ...
      getSolicitudes: 'fin/pagos/refresh',
    ...
    pagar () {
      this.$showMessage('¡Aviso!', 'En espera de modificaciones')
    },
