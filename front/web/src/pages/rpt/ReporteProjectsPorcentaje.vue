        ...
        <div class="col-sm-4">
          <div class="q-pa-sm q-gutter-sm">
            <q-breadcrumbs align="left">
              ...
              <q-breadcrumbs-el class="page-title" label="Presupuesto de projects" to="/reporte_presupuesto_projects" />
            </q-breadcrumbs>
          </div>
        </div>
        <!-- -->
              ...
              <q-table id="sticky-table-newstyle"
                  ...
                  <template slot="body" slot-scope="props">
                    <q-tr :props="props">
                      ...
                      <q-td  key="creado" :props="props" style="text-align: left;">{{ props.row.creado }}</q-td>
                      ...
                      <q-td key="recurso_solicitado" :props="props">${{ props.row.recurso_solicitado }}</q-td>
...
export default {
    ...
    return {
      ...
      form: {
        ...
        columns: [
          ...
          { name: 'creado', label: 'Fecha creación', field: 'creado', sortable: true, type: 'string', align: 'right' },
          ...
          { name: 'recurso_solicitado', label: 'Recurso solicitado', field: 'recurso_solicitado', sortable: true, type: 'string', align: 'right' },
          { name: 'recurso_ejercido', label: 'Recurso ejercido', field: 'recurso_ejercido', sortable: true, type: 'string', align: 'right' },
          { name: 'recurso_por_ejercer', label: 'Recurso por ejercer', field: 'recurso_por_ejercer', sortable: true, type: 'string', align: 'right' },
  ...
  methods: {
    ...
    async cargarDatosReporte () {
      this.form.loading = true
      this.form.data = []
      await axios.get(`/reportes/reporteProjects/${this.form.fields.lider_id}/${this.form.fields.empresa_id}/${this.form.fields.estado_id}/${this.form.fields.municipio_id}/${this.year}`).then(({data}) => {
    ...
    exportCSV () {
      let uri = process.env.API + `reportes/exportCSV_reporteProjects/${this.form.fields.lider_id}/${this.form.fields.empresa_id}/${this.form.fields.estado_id}/${this.form.fields.municipio_id}/${this.year}`
