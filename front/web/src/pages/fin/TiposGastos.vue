          ...
          <div class="col-sm-6">
            <div class="q-pa-sm q-gutter-sm">
              <q-breadcrumbs align="left">
                ...
                <q-breadcrumbs-el class="q-ml-sm grey-8 fs28 page-title" label="Tipos de gastos" />
              </q-breadcrumbs>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="q-pa-sm q-gutter-sm">
              <q-breadcrumbs align="left">
                <q-breadcrumbs-el label="" icon="home" to="/dashboard" />
                <q-breadcrumbs-el label="Tipos de gasto" to="" @click.native="setView('grid')"/>
                <q-breadcrumbs-el label="Nuevo tipo de gasto"/>
              </q-breadcrumbs>
            </div>
          </div>
          <div class="col-sm-6 pull-right">
        ...
        <div class="row bg-white border-panel">
          <div class="col q-pa-md">
            <div class="row q-col-gutter-xs">
              <div class="col-sm-6">
                <q-field icon="fas fa-dollar-sign" icon-color="dark" :error="$v.form.fields.nombre.$error" error-label="Ingrese el tipo de gasto">
                  <q-input upper-case v-model="form.fields.nombre" type="text" inverted color="dark" float-label="Tipo de gasto" maxlength="100" />
                </q-field>
              </div>
            </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      tiposgastos: 'fin/tiposgastos/tiposgastos'
    })
  },
  created () {
    this.loadAll()
  ...
  methods: {
    ...mapActions({
      getEstados: 'fin/tiposgastos/refresh',
      saveEstado: 'fin/tiposgastos/save',
      updateEstado: 'fin/tiposgastos/update',
      deleteEstado: 'fin/tiposgastos/delete'
    }),
    async loadAll () {
