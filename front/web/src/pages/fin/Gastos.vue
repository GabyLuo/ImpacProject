<template>
  <q-page>
    <div v-if="views.grid">
          ...
          <div class="col-sm-4">
            <div class="q-pa-sm q-gutter-sm">
              <q-breadcrumbs align="left">
                ...
                <q-breadcrumbs-el class="q-ml-sm grey-8 fs28 page-title" label="Solicitudes"/>
              </q-breadcrumbs>
            </div>
          </div>
        ...
        <div class="row bg-white border-panel">
          <div class="col q-pa-md">
            <div class="row q-col-gutter-xs"> <!-- AQUI EMPIEZAN LOS FILTROS -->
              ...
              <div class="col-sm-3">
                <q-field icon="person" icon-color="dark">
                  <q-select v-model="form.fields.proveedor_id" inverted color="dark" float-label="Razon social" :options="proveedoresOptionsRazon" filter/>
                </q-field>
              </div>
              <div class="col-sm-3">
                <q-field icon="person" icon-color="dark">
              ...
              <div class="col-sm-3">
                <q-field icon="date_range" icon-color="dark">
                  <q-datetime v-model="form.fields.fecha_inicio" type="date" inverted color="dark" float-label="Fecha inicio" align="center" format="DD/MM/YYYY"></q-datetime>
                </q-field>
              </div>
              <div class="col-sm-3">
                <q-field icon="date_range" icon-color="dark">
                  <q-datetime v-model="form.fields.fecha_fin" type="date" inverted color="dark" float-label="Fecha fin" align="center" format="DD/MM/YYYY"></q-datetime>
                </q-field>
              </div>
              <div class="col-sm-3">
                <q-field icon="person" icon-color="dark">
                  <q-select v-model="form.fields.clasificado" inverted color="dark" float-label="Clasificado" :options="form.selectClasificado" filter/>
                </q-field>
              </div>
              <div class="col-sm-3">
                <q-field icon="date_range" icon-color="dark">
                  <q-datetime v-model="form.fields.fecha_programada" type="date" inverted color="dark" float-label="Fecha programada" align="center" format="DD/MM/YYYY"></q-datetime>
                </q-field>
              </div>
              <div class="col-sm-3 pull-right">
                <q-btn @click="filtrar()" inverted color="orange" icon-right="fas fa-filter" :loading="loadingButton">Filtrar</q-btn>
                <q-btn @click="borrar_filtros()" color="red" icon="loop"><q-tooltip>Borrar</q-tooltip></q-btn>
              </div>
            </div>
          </div>
        </div>
                ...
                <q-table id="sticky-table-newstyle"
                  ...
                  <template slot="body" slot-scope="props">
                    <q-tr :props="props">
                      ...
                      <q-td key="fecha_creado_validacion" :props="props">{{ props.row.f_creado }}</q-td>
                      <q-td key="fecha_solicitado_validacion" :props="props">{{ props.row.f_solicitado }}</q-td>
                      <q-td key="f_programada" :props="props">{{ props.row.f_programada }}</q-td>
                      ...
                      <q-td key="compra_folio" :props="props">{{ props.row.compra_folio }}</q-td>
                      <q-td key="acciones" :props="props">
                      <q-btn small flat @click="verInformacion(props.row)" color="blue" icon="edit">
                          <q-tooltip>Ver detalles</q-tooltip>
                      </q-btn>
                      <q-btn small flat @click="eliminarSolicitud(props.row)" color="red" icon="delete" v-if="(props.row.colaborador === true && props.row.status === 'CREADO' && props.row.creador === user_id) || (role === 'Admin' && props.row.status === 'CREADO') || (role === 'Planeación' && props.row.status === 'CREADO')">
      ...
      <q-modal no-backdrop-dismiss v-if="form_solicitudes.solicitudes_proyecto" style="background-color: rgba(0,0,0,0.7);" v-model="form_solicitudes.solicitudes_proyecto" :content-css="{width: '60vw', height: '400px'}">
        <q-modal-layout>
        ...
        <div class="row q-mt-lg" style="margin-top:70px;margin-right:20px;">
          ...
          <div class="row q-mt-lg subtitulos" style="margin-left:30px;" v-if="form_solicitudes.fields.proveedor_id > 0">
            <div class="col-sm-12" v-if="form_proveedor.fields.banco!== '' && form_proveedor.fields.clabe!== ''">
              <q-checkbox v-model="banco1" :label="'CLABE ' + form_proveedor.fields.banco + ' - ' + form_proveedor.fields.clabe" color="amber"  @click.native="clickCuenta1()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco2!== '' && form_proveedor.fields.clabe2!== ''">
              <q-checkbox v-model="banco2" :label="'CLABE ' + form_proveedor.fields.banco2 + ' - ' + form_proveedor.fields.clabe2" color="amber" @click.native="clickCuenta2()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco3!== '' && form_proveedor.fields.clabe3!== ''">
              <q-checkbox v-model="banco3" :label="' CLABE ' + form_proveedor.fields.banco3 + ' - ' + form_proveedor.fields.clabe3" color="amber"  @click.native="clickCuenta4()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco4!== '' && form_proveedor.fields.clabe4!== ''">
              <q-checkbox v-model="banco4" :label="'CLABE ' + form_proveedor.fields.banco4 + ' - ' + form_proveedor.fields.clabe4" color="amber"  @click.native="clickCuenta5()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco!== '' && form_proveedor.fields.tarjeta1!== ''">
              <q-checkbox v-model="tarjeta1" :label="'TARJETA ' + form_proveedor.fields.banco + ' - ' + form_proveedor.fields.tarjeta1" color="amber"  @click.native="clickCuenta6()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco2!== '' && form_proveedor.fields.tarjeta2!== ''">
              <q-checkbox v-model="tarjeta2" :label="'TARJETA ' + form_proveedor.fields.banco2 + ' - ' + form_proveedor.fields.tarjeta2" color="amber" @click.native="clickCuenta7()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco3!== '' && form_proveedor.fields.tarjeta3!== ''">
              <q-checkbox v-model="tarjeta3" :label="'TARJETA ' + form_proveedor.fields.banco3 + ' - ' + form_proveedor.fields.tarjeta3" color="amber"  @click.native="clickCuenta8()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.banco4!== '' && form_proveedor.fields.tarjeta4!== ''">
              <q-checkbox v-model="tarjeta4" :label="'TARJETA ' + form_proveedor.fields.banco4 + ' - ' + form_proveedor.fields.tarjeta4" color="amber"  @click.native="clickCuenta9()"/>
            </div>
            <div class="col-sm-12" v-if="form_proveedor.fields.toka!== ''">
              <q-checkbox v-model="toka" :label="'TOKA ' + '- ' + form_proveedor.fields.toka" color="amber"  @click.native="clickCuenta3()"/>
            </div>
          </div>
        </div>
            ...
            <div class="col-sm-6">
              <div class="q-pa-sm q-gutter-sm">
                <q-breadcrumbs align="left">
                  ...
                  <q-breadcrumbs-el label=""/><label style="padding-top: 10px;">{{form_solicitudes.fields.id}} </label>
                </q-breadcrumbs>
              </div>
            </div>
            <div class="col-sm-6 pull-right">
              <q-btn @click="regresar()" class="btn_regresar" icon="fa-arrow-left" style="margin-right: 10px;"/>
              <div class="col-xs-12 col-sm-12 col-md-12 pull-right" >
                ...
                <q-btn v-if="(form_solicitudes.fields.pagos && form_solicitudes.fields.autorizacion_id===0)" style="margin-right: 10px" @click="pagoParcialSolicitud()" class="btn_pagar" icon="done">Pago Parcial</q-btn>
          ...
          <div class="row bg-white border-panel">
            <div class="col q-pa-md col-sm-12">
              <div class="row q-col-gutter-xs">
                <div class="col-sm-4" v-if="(form_solicitudes.fields.status==='CREADO' || form_solicitudes.fields.status==='RECHAZADO' || form_solicitudes.fields.status==='POR AUTORIZAR') && form_solicitudes.fields.colaborador && (form_solicitudes.fields.autorizacion_id===null || form_solicitudes.fields.autorizacion_id===1)">
                  <q-field icon="fas fa-building" icon-color="dark">
                ...
                <div class="col-sm-4" v-else>
                  <q-field icon="date_range" icon-color="dark">
                    <q-datetime v-model="form_solicitudes.fields.fecha_programada" type="date" inverted color="dark" float-label="Fecha programada" align="center" @input="actualizarSolicitud()"></q-datetime>
                  </q-field>
                </div>
              </div>
              <div class="row q-col-gutter-xs">
                <div class="col-sm-4">
                  <q-field icon="work" icon-color="dark" >
                    <q-select v-model="form_solicitudes.fields.proyecto_id" inverted color="dark" float-label="Presupuesto" :options="proyectosOpt" filter @input="actualizar_solicitud()" v-if="(form_solicitudes.fields.status==='CREADO' || form_solicitudes.fields.status==='RECHAZADO') && form_solicitudes.fields.colaborador && form_solicitudes.fields.autorizacion_id===null"/>
                    <q-select readonly v-model="form_solicitudes.fields.proyecto_id" inverted color="dark" float-label="Presupuesto" :options="proyectosGeneralOptions" filter @input="actualizar_solicitud()" v-else/>
                  </q-field>
                </div>
                <div class="col-sm-2" style="margin-left:40px;">
                  <!-- <q-checkbox v-model="incluir_iva" label="CON IVA" color="amber" @click.native="clickIva()"/> -->
                  <q-checkbox v-model="incluir_iva" label="CON FACTURA" color="amber" v-if="form_solicitudes.fields.colaborador && (form_solicitudes.fields.autorizacion_id===null || form_solicitudes.fields.autorizacion_id===1) && form_solicitudes.fields.iva==='SI'" @click.native="clickIva()"/>
                  <q-checkbox v-model="incluir_iva" label="CON FACTURA" color="amber" v-if="form_solicitudes.fields.colaborador && (form_solicitudes.fields.autorizacion_id===null || form_solicitudes.fields.autorizacion_id===1) && form_solicitudes.fields.iva==='NO'" @click.native="clickIva()"/>
                  <q-checkbox readonly v-model="incluir_iva" label="CON FACTURA" color="amber" v-if="(!form_solicitudes.fields.colaborador && form_solicitudes.fields.iva === 'SI') || (form_solicitudes.fields.colaborador && form_solicitudes.fields.autorizacion_id!==null && form_solicitudes.fields.autorizacion_id!==1 && form_solicitudes.fields.iva === 'SI')"/>
                  <q-checkbox readonly v-model="incluir_iva" label="CON FACTURA" color="amber" v-if="(!form_solicitudes.fields.colaborador && form_solicitudes.fields.iva === 'NO') || (form_solicitudes.fields.colaborador && form_solicitudes.fields.autorizacion_id!==null && form_solicitudes.fields.autorizacion_id!==1 && form_solicitudes.fields.iva === 'NO')"/>
                </div>
                <div class="col-sm-2">
                  <q-checkbox v-model="sin_factura_solicitud" label="SIN FACTURA" color="amber" @click.native="clickFactura()" :readonly="form_solicitudes.fields.autorizacion_id!==null && form_solicitudes.fields.autorizacion_id!==1"/>
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-4" v-if="form_solicitudes.fields.status==='POR PAGAR' || form_solicitudes.fields.status==='PAGADO'">
                  <q-field icon="work" icon-color="dark" >
                    <q-select v-model="form_solicitudes.fields.proyecto_comision_id" inverted color="dark" float-label="Presupuesto comisionado" :options="proyectosFiltro" filter @input="actualizar_solicitud()"/>
                  </q-field>
                </div>
              ...
              <div class="row q-col-gutter-xs" v-if="(form_solicitudes.fields.status==='CREADO' || form_solicitudes.fields.status==='RECHAZADO' || form_solicitudes.fields.status === 'POR AUTORIZAR') && form_solicitudes.fields.colaborador && (form_solicitudes.fields.autorizacion_id===null || form_solicitudes.fields.autorizacion_id===1)">
                <div class="col-sm-4">
                  <q-field icon="business" icon-color="dark" :error="$v.form_gastos.fields.proveedor_id.$error" error-label="Elija un proveedor">
                    <q-select v-model="form_gastos.fields.proveedor_id" inverted color="dark" float-label="Proveedor" :options="proveedoresOptions" filter @input="getCuentasProveedorClear()"/>
                  </q-field>
                </div>
                <div class="col-sm-4">
                  <q-field icon="business" icon-color="dark" :error="$v.form_gastos.fields.pago.$error" error-label="Elija una cuenta para realizar el pago">
                    <q-select v-model="form_gastos.fields.pago" inverted color="dark" float-label="Cuenta de pago" :options="cuentasOptions" filter/>
                  </q-field>
                </div>
                <!-- <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                  <q-field icon="fas fa-dollar-sign" icon-color="dark" :error="$v.form_gastos.fields.montovalidar.$error" error-label="Monto mínimo $0.01" helper="Monto a pagar">
                    <money v-model="form_gastos.fields.montovalidar" v-bind="money" style="height:53px;width:100%;" v-bind:class="{ moneyBien: !($v.form_gastos.fields.montovalidar.$error), moneyError: $v.form_gastos.fields.montovalidar.$error }" @input="$v.form_gastos.fields.montovalidar.$touch"></money>
                  </q-field>
                </div>
                <div class="col-sm-10">
                    ...
                    <q-table id="sticky-table-newstyle"
                      ...
                      <template slot="body" slot-scope="props">
                        <q-tr :props="props" style="cursor: pointer;">
                          ...
                          <q-td @click.native="cardGasto(true, props.row.id)" key="nombre_actividad" :props="props">{{ props.row.nombre_actividad }}
                          ...
                          <q-td key="cotizacion" :props="props">
                            ...
                            <input id="archivo" style="display:none" inverted color="dark" stack-label="Archivo" type="file" name="" value="" ref="cotizacionInput" accept=".png, .jpg, .jpeg, .xml, .docx, .pdf, .PNG, .JPG, .JPEG, .XML, .DOCX, .PDF, .txt, .TXT" @change="uploadCotizacionFile()" />
                              ...
                              <q-btn small flat :icon="cot.icon" :color="cot.color">
                                ...
                                <q-popover>
                                  <q-list link separator class="scroll" style="min-width: 100px">
                                    <q-item v-close-overlay @click.native="verCotizacion(cot)" v-if="cot.doc_type !== 'docx' && cot.doc_type !== 'xml' && cot.doc_type !== 'xlsx' && cot.doc_type !== 'XLSX' && cot.doc_type !== 'DOCX' && cot.doc_type !== 'txt' && cot.doc_type !== 'TXT'">
                          ...
                          <q-td key="factura" :props="props">
                            ...
                            <!-- </q-field> -->
                            <input id="archivo" style="display:none" inverted color="dark" stack-label="Archivo" type="file" name="" value="" ref="facturaInput" accept=".png, .jpg, .jpeg, .xml, .docx, .pdf, .PNG, .JPG, .JPEG, .XML, .DOCX, .PDF, .txt, .TXT" @change="uploadFacturaFile()" />
                            ...
                            <div style="display: inline;" v-for="fac in props.row.factura" :key="fac.id">
                              <q-btn small flat :icon="fac.icon" :color="fac.color">
                                ...
                                <q-popover>
                                  <q-list link separator class="scroll" style="min-width: 100px">
                                    <q-item v-close-overlay @click.native="verFactura(fac)" v-if="fac.doc_type !== 'docx' && fac.doc_type !== 'xml' && fac.doc_type !== 'XML' && fac.doc_type !== 'xlsx' && fac.doc_type !== 'txt' && fac.doc_type !== 'TXT'">
                                      <q-item-main label="Ver"/>
                                    </q-item>
                          ...
                          <q-td key="comprobante" :props="props">
                            ...
                            <div style="display: inline;" v-for="com in props.row.comprobante" :key="com.id">
                              <q-btn small flat :icon="com.icon" :color="com.color">
                                ...
                                <q-popover>
                                  <q-list link separator class="scroll" style="min-width: 100px">
                                    <q-item v-close-overlay @click.native="verComprobante(com)" v-if="com.doc_type !== 'docx' && com.doc_type !== 'xml' && com.doc_type !== 'xlsx' && com.doc_type !== 'txt' && com.doc_type !== 'TXT'">
                                      <q-item-main label="Ver"/>
                                    </q-item>
              ...
              <div class="row q-col-gutter-xs" v-if="form_gastos.modal_informacion">
                <q-card v-if="form_gastos.modal_informacion" style="margin-top:15px;">
                  <q-card-main>
                    ...
                    <div class="row q-mt-lg">
                      ...
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'banco1'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="CLABE"/>
                        </q-field>
                      </div>
                      ...
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'tarjeta1'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="TARJETA"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.tarjeta1" inverted-color="dark" float-label="TARJETA"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3">
                        <q-field icon="account_balance" icon-color="dark">
                      ...
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'banco2'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="CLABE 2"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                      ...
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'tarjeta2'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="TARJETA 2"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.tarjeta2" inverted-color="dark" float-label="TARJETA 2"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'toka'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="toka"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                      ...
                      <div class="col-sm-3">
                        <q-field icon="account_balance" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.banco3" inverted-color="dark" float-label="Banco 3"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'banco3'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="CLABE 3"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.clabe3" inverted-color="dark" float-label="CLABE 3"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'tarjeta3'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="TARJETA 3"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.tarjeta3" inverted-color="dark" float-label="TARJETA 3"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3">
                        <q-field icon="account_balance" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.banco4" inverted-color="dark" float-label="Banco 4"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'banco4'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="CLABE 4"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.clabe4" inverted-color="dark" float-label="CLABE 4"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-if="form_gastos.detalles.pago === 'tarjeta4'">
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.cuenta_pago" inverted color="teal" float-label="TARJETA 4"/>
                        </q-field>
                      </div>
                      <div class="col-sm-3" v-else>
                        <q-field icon="vpn_key" icon-color="dark">
                          <q-input readonly upper-case v-model="form_gastos.detalles.tarjeta4" inverted-color="dark" float-label="TARJETA 4"/>
                        </q-field>
                      </div>
                    </div>
                  </q-card-main>
              ...
              <div class="row q-col-gutter-xs" style="padding-top: 15px;">
                <!-- <div class="col-sm-12"> -->
                  ...
                  <q-collapsible class="col-sm-12" @click="cargarArchivos()" v-model="open_archivos" style="padding-left: 0;padding-right: 0;border-bottom: 1px solid teal;" icon="note" label="Archivos de la solicitud">
                    <!-- aqui va el contenido -->
                    <div class="col-sm-3 pull-right">
                      <input style="display:none" inverted color="dark" stack-label="Archivo" @change="uploadFormato()" type="file" name="" value="" ref="fileInputFormato" accept=".txt, .TXT, .jpg, .jpeg, .png, .pdf, .docx, .PNG, .JPG, .JPEG, .XML, .DOCX, .PDF" />
                        <q-btn @click="$refs.fileInputFormato.click()" color="tertiary" icon="attach_file" :loading="loadingButton">&nbsp; Cargar Archivo</q-btn>
                    </div>
                    <div class="row q-mt-sm" style="margin-top:30px;padding: 0;">
                      <div class="col-sm-12 q-mt-sm" id="sticky-table-scroll-corto">
                        <q-table id="sticky-table-newstyle"
        ...
        <div class="row q-mt-lg" style="margin-top:70px;margin-right:20px;">
          <div class="col-sm-12">
            ...
            <div class="row q-mt-lg">
              ...
              <div class="row q-mt-sm" style="margin-left:15px;margin-right:45px;">
                ...
                <div class="col-sm-12 q-mt-sm" id="sticky-table-scroll">
                  <q-table id="sticky-table"
                    ...
                    <template slot="body" slot-scope="props">
                      <q-tr :props="props" style="cursor: pointer;">
                        <q-td @click.native="cardGasto(true, props.row.id)" key="nombre_actividad" :props="props">{{ props.row.nombre_actividad }}</q-td>
                        <q-td key="cotizacion" :props="props">
                          <div style="display: inline;" v-for="cot in props.row.cotizacion" :key="cot.id">
                            <q-btn small flat :icon="cot.icon" :color="cot.color">
                              <q-tooltip>{{ cot.name }}</q-tooltip>
              ...
              <detalle-gasto :show="form_gastos.modal_informacion" :gasto_id="form_gastos.fields.id" @closeCard="cardGasto($event)"/>
            </div>
          </div>
        </div>
        ...
        <div class="row" style="margin-right: 20px;">
          <div class="col-sm-12">
            ...
            <div class="row q-mt-lg">
              ...
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.tarjeta1.$error" error-label="Verifique el número de tarjeta">
                  <q-input  @keyup="isNumber($event,'tarjeta1')" upper-case v-model="form_proveedor.fields.tarjeta1" inverted color="dark" float-label="Tarjeta"/>
                </q-field>
              </div>
              <div class="col-sm-4">
              ...
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.tarjeta2.$error" error-label="Verifique el número de tarjeta">
                  <q-input  @keyup="isNumber($event,'tarjeta2')" upper-case v-model="form_proveedor.fields.tarjeta2" inverted color="dark" float-label="Tarjeta"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="account_balance" icon-color="dark" :error="$v.form_proveedor.fields.banco3.$error" error-label="Escriba el nombre del Banco">
                  <q-input upper-case v-model="form_proveedor.fields.banco3" inverted color="dark" float-label="Banco 3"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.clabe3.$error" error-label="Verifique el número clabe">
                  <q-input  @keyup="isNumber($event,'clabe3')" upper-case v-model="form_proveedor.fields.clabe3" inverted color="dark" float-label="CLABE 3"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.tarjeta3.$error" error-label="Verifique el número de tarjeta">
                  <q-input  @keyup="isNumber($event,'tarjeta3')" upper-case v-model="form_proveedor.fields.tarjeta3" inverted color="dark" float-label="Tarjeta"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="account_balance" icon-color="dark" :error="$v.form_proveedor.fields.banco4.$error" error-label="Escriba el nombre del Banco">
                  <q-input upper-case v-model="form_proveedor.fields.banco4" inverted color="dark" float-label="Banco 4"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.clabe4.$error" error-label="Verifique el número clabe">
                  <q-input  @keyup="isNumber($event,'clabe4')" upper-case v-model="form_proveedor.fields.clabe4" inverted color="dark" float-label="CLABE 4"/>
                </q-field>
              </div>
              <div class="col-sm-4">
                <q-field icon="vpn_key" icon-color="dark" :error="$v.form_proveedor.fields.tarjeta4.$error" error-label="Verifique el número de tarjeta">
                  <q-input  @keyup="isNumber($event,'tarjeta4')" upper-case v-model="form_proveedor.fields.tarjeta4" inverted color="dark" float-label="Tarjeta"/>
                </q-field>
              </div>
            </div>
            <div class="row q-mt-lg">
...
import { required, minValue, maxLength, email, minLength, helpers } from 'vuelidate/lib/validators'
// import {VMoney} from 'v-money'
import {Money} from 'v-money'
import axios from 'axios'
import DetalleGasto from '../../components/layout/fin/DetalleGasto'
...
export default {
  ...
  beforeRouteEnter (to, from, next) {
    next(vm => {
      ...
      for (let i = 0; i < propiedades.length; i++) {
        if (propiedades[i].toUpperCase() === 'admin'.toUpperCase() || propiedades[i].toUpperCase() === 'ROOT'.toUpperCase() || propiedades[i].toUpperCase() === 'CLIENTE'.toUpperCase() || propiedades[i].toUpperCase() === 'LIDER'.toUpperCase() || propiedades[i].toUpperCase() === 'COORDINADOR'.toUpperCase() || propiedades[i].toUpperCase() === 'GERENTE DE OPERACIONES'.toUpperCase() || propiedades[i].toUpperCase() === 'PMO'.toUpperCase() || propiedades[i].toUpperCase() === 'FINANZAS'.toUpperCase() || propiedades[i].toUpperCase() === 'OPERACIÓN'.toUpperCase() || propiedades[i].toUpperCase() === 'LICITACIONES - SOLICITUDES'.toUpperCase() || propiedades[i].toUpperCase() === 'GERENTE'.toUpperCase() || propiedades[i].toUpperCase() === 'AUXILIAR'.toUpperCase() || propiedades[i].toUpperCase() === 'COBRANZA'.toUpperCase() || propiedades[i].toUpperCase() === 'INVENTARIOS'.toUpperCase() || propiedades[i].toUpperCase() === 'VENTAS'.toUpperCase() || propiedades[i].toUpperCase() === 'PLANEACIÓN'.toUpperCase() || propiedades[i].toUpperCase() === 'Coordinador GDP'.toUpperCase() || propiedades[i].toUpperCase() === 'COMPRAS'.toUpperCase() || propiedades[i].toUpperCase() === 'FINANZAS/COMISIONES'.toUpperCase() || propiedades[i].toUpperCase() === 'LICITACIONES'.toUpperCase() || propiedades[i].toUpperCase() === 'AUXILIAR TESORERIA'.toUpperCase()) {
          condicion = true
        }
      }
      if (condicion) {
  ...
  data () {
    return {
      ivaOptions: [ { label: 'CON IVA', value: true }, { label: 'SIN IVA', value: false } ],
      facturaOptions: [ { label: 'CON FACTURA', value: true }, { label: 'SIN FACTURA', value: false } ],
      cuentasOptions: [],
      role: '',
      user_id: 0,
      ...
      form: { // para los filtros
        fields: {
          ...
          fecha_fin: null,
          clasificado: 'all',
          fecha_programada: `${new Date().getDate() + 1}/${new Date().getMonth() + 1}/${new Date().getFullYear()}`
        },
        ...
        selectClasificado: [ { 'label': 'SI', 'value': 'SI' }, { 'label': 'NO', 'value': 'NO' }, { 'label': 'Todos', 'value': 'all' } ]
      },
      form_solicitudes: {
        fields: {
          id: 0,
        ...
        columns: [
          ...
          { name: 'fecha_creado_validacion', label: 'creación', field: 'fecha_creado_validacion', sortable: true, type: 'string', align: 'center' },
          { name: 'fecha_solicitado_validacion', label: 'solicitud', field: 'fecha_solicitado_validacion', sortable: true, type: 'string', align: 'center' },
          { name: 'f_programada', label: 'programada', field: 'f_programada', sortable: true, type: 'string', align: 'center' },
          ...
          { name: 'compra_folio', label: 'Compra', field: 'compra_folio', sortable: true, type: 'string', align: 'center' },
  ...
  computed: {
    ...mapGetters({
      ...
      proyectosGeneralOptions: 'pmo/proyecto/selectOptions'
    }),
  ...
  watch: {
    incluir_iva (newValue, old) {
      ...
      if (newValue === true) {
        ...
        this.sin_factura_solicitud = false
        this.cargarGastos()
      }
      if (newValue === false) {
        ...
        this.sin_factura_solicitud = true
        this.cargarGastos()
      }
    },
    ...
    sin_factura_solicitud (newValue, old) {
      this.form_solicitudes.contador_bandera_factura++
      if (newValue === true) {
        this.form_solicitudes.fields.factura = 'NO'
    ...
    banco1 (newValue, old) {
      if (newValue === true) {
        ...
        this.form_solicitudes.fields.banco3 = 'NO'
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        this.form_solicitudes.fields.tarjeta2 = 'NO'
        this.form_solicitudes.fields.tarjeta3 = 'NO'
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'banco1'
      }
      if (newValue === false) {
    ...
    banco2 (newValue, old) {
      if (newValue === true) {
        ...
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'banco2'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.banco2 = 'NO'
      }
    ...
    banco3 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.banco3 = 'SI'
        this.form_solicitudes.fields.banco2 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        ...
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'banco3'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.banco3 = 'NO'
      }
    ...
    banco4 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.banco4 = 'SI'
        this.form_solicitudes.fields.banco2 = 'NO'
        this.form_solicitudes.fields.banco3 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        ...
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'banco4'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.banco4 = 'NO'
      }
    ...
    toka (newValue, old) {
      if (newValue === true) {
        ...
        this.form_solicitudes.fields.tarjeta3 = 'NO'
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_gastos.fields.pago = 'toka'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.toka = 'NO'
      }
    },
    tarjeta1 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.tarjeta1 = 'SI'
        this.form_solicitudes.fields.tarjeta2 = 'NO'
        this.form_solicitudes.fields.tarjeta3 = 'NO'
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        ...
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'tarjeta1'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.tarjeta1 = 'NO'
      }
    },
    tarjeta2 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.tarjeta2 = 'SI'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        this.form_solicitudes.fields.tarjeta3 = 'NO'
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        ...
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'tarjeta2'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.tarjeta2 = 'NO'
      }
    },
    tarjeta3 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.tarjeta3 = 'SI'
        this.form_solicitudes.fields.tarjeta2 = 'NO'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        this.form_solicitudes.fields.tarjeta4 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        ...
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'tarjeta3'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.tarjeta3 = 'NO'
      }
    },
    tarjeta4 (newValue, old) {
      if (newValue === true) {
        this.form_solicitudes.fields.tarjeta4 = 'SI'
        this.form_solicitudes.fields.tarjeta2 = 'NO'
        this.form_solicitudes.fields.tarjeta3 = 'NO'
        this.form_solicitudes.fields.tarjeta1 = 'NO'
        this.form_solicitudes.fields.banco1 = 'NO'
        ...
        this.form_solicitudes.fields.banco4 = 'NO'
        this.form_solicitudes.fields.toka = 'NO'
        this.form_gastos.fields.pago = 'tarjeta4'
      }
      if (newValue === false) {
        this.form_solicitudes.fields.tarjeta4 = 'NO'
      }
  ...
  methods: {
    ...mapActions({
      ...
      deleteSolicitud: 'fin/solicitudes/delete',
      getCuentas: 'pmo/proveedor/getCuentas',
      getProyectosGeneral: 'pmo/proyecto/refresh',
      getProveedoresRazon: 'pmo/proveedor/getOptions'
    }),
    async loadAll () {
      // await this.getRecursos()
      // await this.getSolicitudes() --------------------------------------
      //
      await this.getProyectosGeneral()
      await this.getRecursos()
      ...
      if (this.$route.params.id > 0 && this.$route.params.accion === 'compra') {
        await this.projects2(this.$route.params.id)
        this.form_solicitudes.fields.proveedor_id = this.$route.params.proveedor
        this.form_solicitudes.fields.empresa_id = this.$route.params.empresa
        await this.newSolicitudCompra(this.form_solicitudes.fields.proyecto_id, this.form_solicitudes.fields.proveedor_id, this.form_solicitudes.fields.empresa_id)
        this.form_solicitudes.fields.compra_id = this.$route.params.compra
    ...
    async loadProveedores () {
      await this.getProveedoresRazon().then(({data}) => {
        this.proveedoresOptionsRazon = data.proveedores
      }).catch(error => {
        console.log(error)
      })
    },
    ...
    filtrar () {
      ...
      params.fecha_programada = this.invertDate(this.form.fields.fecha_programada)
    ...
    getProveedor () {
      this.getProveedorById({id: this.form_solicitudes.fields.proveedor_id}).then(({data}) => {
        if (data.result === 'success') {
          ...
          this.form_solicitudes.fields.tarjeta4 = 'NO'
          this.form_solicitudes.fields.toka = 'NO'
          this.form_proveedor.fields.clabe = ''
          this.form_proveedor.fields.clabe2 = ''
          this.form_proveedor.fields.clabe3 = ''
          this.form_proveedor.fields.clabe4 = ''
          this.form_proveedor.fields.tarjeta1 = ''
          this.form_proveedor.fields.tarjeta2 = ''
          this.form_proveedor.fields.tarjeta3 = ''
          this.form_proveedor.fields.tarjeta4 = ''
          if (data.proveedorid[0].banco !== null && data.proveedorid[0].clabe !== null) {
            this.form_proveedor.fields.banco = data.proveedorid[0].banco
            this.form_proveedor.fields.clabe = data.proveedorid[0].clabe
          }
          if (data.proveedorid[0].banco2 !== null && data.proveedorid[0].clabe2 !== null) {
            this.form_proveedor.fields.banco2 = data.proveedorid[0].banco2
            this.form_proveedor.fields.clabe2 = data.proveedorid[0].clabe2
          }
          if (data.proveedorid[0].banco3 !== null && data.proveedorid[0].clabe3 !== null) {
            this.form_proveedor.fields.banco3 = data.proveedorid[0].banco3
            this.form_proveedor.fields.clabe3 = data.proveedorid[0].clabe3
          }
          if (data.proveedorid[0].banco4 !== null && data.proveedorid[0].clabe4 !== null) {
            this.form_proveedor.fields.banco4 = data.proveedorid[0].banco4
            this.form_proveedor.fields.clabe4 = data.proveedorid[0].clabe4
          }
          if (data.proveedorid[0].banco !== null && data.proveedorid[0].tarjeta1 !== null) {
            this.form_proveedor.fields.banco = data.proveedorid[0].banco
            this.form_proveedor.fields.tarjeta1 = data.proveedorid[0].tarjeta1
          }
          if (data.proveedorid[0].banco2 !== null && data.proveedorid[0].tarjeta2 !== null) {
            this.form_proveedor.fields.banco2 = data.proveedorid[0].banco2
            this.form_proveedor.fields.tarjeta2 = data.proveedorid[0].tarjeta2
          }
          if (data.proveedorid[0].banco3 !== null && data.proveedorid[0].tarjeta3 !== null) {
            this.form_proveedor.fields.banco3 = data.proveedorid[0].banco3
            this.form_proveedor.fields.tarjeta3 = data.proveedorid[0].tarjeta3
          }
          if (data.proveedorid[0].banco4 !== null && data.proveedorid[0].tarjeta4 !== null) {
            this.form_proveedor.fields.banco4 = data.proveedorid[0].banco4
            this.form_proveedor.fields.tarjeta4 = data.proveedorid[0].tarjeta4
          }
          if (data.proveedorid[0].toka !== null) {
            this.form_proveedor.fields.toka = data.proveedorid[0].toka
          }
        }
      }).catch(error => {
        console.error(error)
    ...
    getCuentasProveedor () {
      this.cuentasOptions = []
      this.getCuentas({id: this.form_gastos.fields.proveedor_id}).then(({data}) => {
        if (data.result === 'success') {
          this.cuentasOptions = data.cuentas
        }
      }).catch(error => {
        console.error(error)
      })
    },
    getCuentasProveedorClear () {
      this.form_gastos.fields.pago = ''
    ...
    async newSolicitud (id) {
      ...
      this.form_solicitudes.fields.fecha_programada = ''
      this.form_solicitudes.fields.comprobado = 'NO'
      this.form_solicitudes.fields.factura = 'NO'
      this.form_solicitudes.fields.total = 0
      ...
      this.form_solicitudes.fields.proyecto_comision_id = 0
      this.banco1 = false
      this.banco2 = false
      this.banco3 = false
      this.banco4 = false
    ...
    async newSolicitudCompra (id, proveedor, empresa) {
      this.$q.loading.show({message: 'Cargando...'})
      this.$v.form_gastos.$reset()
      this.form_solicitudes.fields.id = 0
      this.form_solicitudes.fields.total = 0
      ...
      this.form_solicitudes.fields.sobrepasa_presupuesto = 'NO'
      this.ver_detalles_proveedor = false
      this.form_solicitudes.fields.proveedor_id = parseInt(proveedor)
      this.form_solicitudes.fields.empresa_id = parseInt(empresa)
      await this.getEmpresas()
      await this.getProveedores()
      await this.getProyectosOpt()
      this.form_solicitudes.fields.proyecto_id = id
      ...
      if (this.form_solicitudes.fields.proyecto_id > 0) {
        if (this.form_solicitudes.fields.empresa_id > 0) {
          if (this.form_solicitudes.fields.proveedor_id > 0) {
            if (this.form_solicitudes.fields.banco1 !== 'NO' || this.form_solicitudes.fields.banco2 !== 'NO' || this.form_solicitudes.fields.toka !== 'NO' || this.form_solicitudes.fields.banco3 !== 'NO' || this.form_solicitudes.fields.banco4 !== 'NO' || this.form_solicitudes.fields.tarjeta1 !== 'NO' || this.form_solicitudes.fields.tarjeta2 !== 'NO' || this.form_solicitudes.fields.tarjeta3 !== 'NO' || this.form_solicitudes.fields.tarjeta4 !== 'NO') {
              let params = this.form_solicitudes.fields
              params.compra_id = this.form_solicitudes.fields.compra_id
    ...
    validarGastos () {
      ...
      this.form_gastos.fields.monto = this.form_gastos.fields.montovalidar
      if (this.incluir_iva === true) {
        this.form_gastos.fields.monto_validar_iva = this.form_gastos.fields.monto * 1.16
      } else {
        this.form_gastos.fields.monto_validar_iva = this.form_gastos.fields.monto
      }
      this.$v.form_gastos.$touch()
      if (!this.$v.form_gastos.$error) {
        if ((parseFloat(this.form_gastos.fields.presupuesto_disponible_validar + 1) < parseFloat(this.form_gastos.fields.monto_validar_iva))) {
          this.$q.dialog({
            title: 'Alerta',
            message: 'Esta actividad no cuenta con presupuesto disponible, no se guardará el gasto',
            ok: 'Aceptar',
            cancel: 'Cancelar'
          }).then(() => {
    ...
    editSingleGasto (row) {
      ...
      this.form_gastos.fields.pago = row.pago
      this.getCuentasProveedor()
    ...
    async verInformacion (row) {
      ...
      this.form_solicitudes.fields.proyecto_comision_id = row.proyecto_comision_id
    ...
    async clickSolicitud (row) {
      ...
      this.form_solicitudes.fields.status = row.status
      this.form_solicitudes.fields.fecha_solicitado = row.fecha_solicitado
      this.form_solicitudes.fields.fecha_programada = row.fecha_programada
      this.form_solicitudes.fields.fecha_ejercido = row.fecha_ejercido
      this.form_solicitudes.fields.autorizacion_id = row.autorizacion_id
      this.form_solicitudes.fields.fecha_creado = row.fecha_creado
      this.form_solicitudes.fields.proyecto_id = row.proyecto_id
    ...
    async cargarGastos () {
      ...
      this.form_gastos.data = []
      await this.getGastosBySolicitud({id: this.form_solicitudes.fields.id}).then(({data}) => {
          ...
          data.gastos.forEach(function (element) {
            ...
            if (element.cotizacion.length > 0) {
              element.cotizacion.forEach(function (documento) {
                ...
                } else if (documento.doc_type === 'pdf' || documento.doc_type === 'PDF' || documento.doc_type.toLowerCase() === 'pdf'.toLowerCase()) {
                ...
                } else if (documento.doc_type === 'txt' || documento.doc_type === 'TXT') {
    ...
    async actualizar_solicitud () {
      await this.actualizarSolicitud()
      await this.cargarActandUsers2()
    },
    async actualizarSolicitud () {
      let params = this.form_solicitudes.fields
      await this.updateSolicitud(params).then(({data}) => {
        if (data.result === 'success') {
          this.form_solicitudes.fields.status = data.status
          this.$q.notify({
    ...
    regresar () {
      ...
      this.form_solicitudes.fields.compra_id = 0
      this.filtrar()
      this.form_gastos.modificar = false
      this.limpiar_gasto()
    ...
    isNumber (evt, input) {
      switch (input) {
        case 'telefono':
          this.form_proveedor.fields.telefono = this.form_proveedor.fields.telefono.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.telefono.$touch()
          break
        case 'clabe1':
          this.form_proveedor.fields.clabe = this.form_proveedor.fields.clabe.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.clabe.$touch()
          break
        case 'clabe2':
          this.form_proveedor.fields.clabe2 = this.form_proveedor.fields.clabe2.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.clabe2.$touch()
          break
        case 'clabe3':
          this.form_proveedor.fields.clabe3 = this.form_proveedor.fields.clabe3.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.clabe3.$touch()
          break
        case 'clabe4':
          this.form_proveedor.fields.clabe4 = this.form_proveedor.fields.clabe4.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.clabe4.$touch()
          break
        case 'toka':
          this.form_proveedor.fields.toka = this.form_proveedor.fields.toka.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.toka.$touch()
          break
        case 'tarjeta1':
          this.form_proveedor.fields.tarjeta1 = this.form_proveedor.fields.tarjeta1.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.tarjeta1.$touch()
          break
        case 'tarjeta2':
          this.form_proveedor.fields.tarjeta2 = this.form_proveedor.fields.tarjeta2.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.tarjeta2.$touch()
          break
        case 'tarjeta3':
          this.form_proveedor.fields.tarjeta3 = this.form_proveedor.fields.tarjeta3.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.tarjeta3.$touch()
          break
        case 'tarjeta4':
          this.form_proveedor.fields.tarjeta4 = this.form_proveedor.fields.tarjeta4.replace(/[^0-9.]/g, '')
          this.$v.form_proveedor.fields.tarjeta4.$touch()
          break
        default:
          break
      }
    ...
    eliminarSolicitud (row) {
      this.$q.dialog({
        ...
        this.deleteSolicitud({solicitud_id: row.id}).then(({data}) => {
          if (data.result === 'success') {
            this.$q.notify({
              message: data.message.content, timeout: 3000, type: 'green', textColor: 'white', icon: 'done', position: 'top-right'
            })
    ...
    borrar_filtros () {
      ...
      this.form.fields.responsable_id = 0
      this.form.fields.actividad_id = 0
      this.form.fields.comprobado = 'all'
      this.form.fields.proveedor_id = 0
      this.form.fields.creador_id = 0
    ...
    cardGasto (show, id) {
      this.form_gastos.fields.id = id
      this.clickFilaGasto(id)
    },
    clickFilaGasto (id) {
      this.form_gastos.fields.id = id
      this.form_gastos.modal_informacion = false
      this.getGastoById({id: id}).then(({data}) => {
        if (data.result === 'success') {
  ...
  validations: {
    form_gastos: {
      fields: {
        montovalidar: {required, minValue: minValue(0.01)},
